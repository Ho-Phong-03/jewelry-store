                                        ...
                                        <div class="aside__content">
                                            <div id="ui-slider" class="ui__sider__corner__all">
                                                ...
                                                <div class="range__input">
                                                    <input type="range" class="range__min" min="0" max="10000" value="2500" step="100">
                                                    <input type="range" class="range__max" min="0" max="10000" value="7500" step="100">
                                                </div>
                                            </div>
                                            ...
                                            <div class="aside__price__input">
                                                <div class="fidle">
                                                    <span>Min</span>
                                                    <input type="number" class="input__min" id="input-min" value="2500">
                                                </div>
                                                <span class="separator">-</span>
                                                <div class="fidle">
                                                    <span>Max</span>
                                                    <input type="number" class="input__max" id="input-max" value="7500">
                                                </div>
                                            </div>
                                                ...
                                                <li class="filter__item">
                                                    <span>
                                                        <label for="fa-color-1" class="filter__color">
                                                            <input type="checkbox" name="fa-color" value="Vang" id="fa-color-1">
                                                            <span>Vàng</span>
                                                        </label>
                                                    </span>
                                                </li>
                                                <li class="filter__item">
                                                    <span>
                                                        <label for="fa-color-2" class="filter__color">
                                                            <input type="checkbox" name="fa-color" value="Do" id="fa-color-2">
                                                            <span>Do</span>
                                                        </label>
                                                    </span>
                                                </li>
                                                <li class="filter__item">
                                                    <span>
                                                        <label for="fa-color-3" class="filter__color">
                                                            <input type="checkbox" name="fa-color" value="Trang" id="fa-color-3">
                                                            <span>Trang</span>
                                                        </label>
                                                    </span>
                                                </li>
                                                <li class="filter__item">
                                                    <span>
                                                        <label for="fa-color-4" class="filter__color">
                                                            <input type="checkbox" name="fa-color" value="Nau" id="fa-color-4">
                                                            <span>Nau</span>
                                                        </label>
                                                    </span>
                                                </li>
                                                <li class="filter__item">
                                                    <span>
                                                        <label for="fa-color-5" class="filter__color">
                                                            <input type="checkbox" name="fa-color" value="Dacam" id="fa-color-5">
                                                            <span>Da cam</span>
                                                        </label>
                                                    </span>
                                                </li>
                                                <li class="filter__item">
                                                    <span>
                                                        <label for="fa-color-6" class="filter__color">
                                                            <input type="checkbox" name="fa-color" value="Hong" id="fa-color-6">
                                                            <span>Hong</span>
                                                        </label>
                                                    </span>
                                                </li>
                                                ...
                                                <li class="filter__item">
                                                    <span>
                                                        <label for="size-xs" class="filter__size">
                                                            <input type="checkbox" class="inp__size" name="size-xs" id="size-xs">
                                                            XS
                                                        </label>
                                                    </span>
                                                </li>
                                                <li class="filter__item">
                                                    <span>
                                                        <label for="size-s" class="filter__size">
                                                            <input type="checkbox" class="inp__size" name="size-s" id="size-s">
                                                            S
                                                        </label>
                                                    </span>
                                                </li>
                                                <li class="filter__item">
                                                    <span>
                                                        <label for="size-m" class="filter__size">
                                                            <input type="checkbox" class="inp__size" name="size-m" id="size-m">
                                                            M
                                                        </label>
                                                    </span>
                                                </li>
                                                <li class="filter__item">
                                                    <span>
                                                        <label for="size-l" class="filter__size">
                                                            <input type="checkbox" class="filter" name="size-l" id="size-l">
                                                            L
                                                        </label>
                                                    </span>
                                                </li>
                                                <li class="filter__item">
                                                    <span>
                                                        <label for="size-xl" class="filter__size">
                                                            <input type="checkbox" class="inp__size" name="size-xl" id="size-xl">
                                                            XL
                                                        </label>
                                                    </span>
                                                </li>
                                                <li class="filter__item">
                                                    <span>
                                                        <label for="size-xxl" class="filter__size">
                                                            <input type="checkbox" class="inp__size" name="size-xxl" id="size-xxl">
                                                            XXL
                                                        </label>
                                                    </span>
                                                </li>
                                            ...
                                            <ul class="box__filter__vendor">
                                                <li class="filter__item">
                                                    <label for="inp-vendor-1" class="filter__vendor">
                                                        <input type="checkbox" class="inp__vendor" name="vendor-1" id="inp-vendor-1" value="Cartier">
                                                        Cartier
                                                    </label>
                                                </li>
                                                <li class="filter__item">
                                                    <label for="inp-vendor-2" class="filter__vendor">
                                                        <input type="checkbox" class="inp__vendor" name="vendor-2" id="inp-vendor-2" value="Tiffany & Co">
                                                        Tiffany & Co
                                                    </label>
                                                </li>
                                                <li class="filter__item">
                                                    <label for="inp-vendor-3" class="filter__vendor">
                                                        <input type="checkbox" class="inp__vendor" name="vendor-3" id="inp-vendor-3" value="Bvlgari">
                                                        Bvlgari
                                                    </label>
                                                </li>
                                            </ul>
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="product__mini__item">
                                                        <div class="product__img">
                                                            <a href="#"><img src="{{asset('../asset')}}/images/products/product1.jpg" alt=""></a>
                                                        </div>
                                                    </div> 
                                                    <div class="product__info">
                                                        <h3><a href="#" class="product__name">Nhẫn ngọc trai</a></h3>
                                                        <div class="price__box">
