                                ...
                                <div class="product__item">
                                    <div class="single__product">
                                        <div class="product__thumb">
                                            <a href="{{route('showDetailProduct')}}" class="primary__img">
                                                <img src="{{asset('../asset/users')}}/images/slider_image/product1.jpg" alt="">
                                            </a>
                                            <a href="{{route('showDetailProduct')}}" class="secondary__img">
                                        ...
                                        <div class="product__content">
                                            ...
                                            <a href="{{route('showDetailProduct')}}" class="product__title">
                                                <h3 >
                                                    Donec eu furniture
                                                </h3>
                                            </a>
