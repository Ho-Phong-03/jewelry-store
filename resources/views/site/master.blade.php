        ...
        <nav class="nav__header" id="nav-header">
            <div class="nav__header__menu container">
                ...
                <div class="nav__toggle" id="nav-toggle">
                    <img src="{{asset('../asset/users')}}/images/icons/menu-icon-bar.svg" alt="" class="nav__item btn__toggle">
                </div> 

                <a href="#" class="nav__logo">
                    <div class="nav__logo__image">
                        <img src="{{asset('../asset/users')}}/images/logo/logo-image.svg" alt="" class="nav__logo__img">
                    </div>
                    Bonney
                </a>
                    ...
                    <ul class="nav__list__menu__items">
                        ...
                        <li>
                            <div class="nav__link__menu__item" id="nav-btn-cart">
                                <img src="{{asset('../asset/users')}}/images/icons/bag-icon.svg" alt="img" class="nav__item btn__bag">
                            </div>
                                ...
                                <div class="nav__modal__cart" id="nav-modal-cart">
                                    <div class="modal_cart__list">
                                        <div class="cart__item">
                                            <div class="cart__img">
                                                <a href="#">
                                                    <img src="{{asset('../asset/users')}}/images/products/img-product-1.jpg" alt="" class="cart__image">
                                                </a>
                                            </div>
                                    ...
                                    <div class="mini__cart__footer">
                                        <div class="cart__btn view__cart">
                                            <a href="{{ route('showCart') }}"  class="cart__link cart__link_view">View cart</a>
                                        </div>
                                ...
                                <div class="simple__product">
                                    <div class="simple__product__items">
                                        <div class="simple__product__thumb">
                                            <a href="#"><img src="{{asset('../asset/users')}}/images/slider_image/product1.jpg" alt=""></a>
                                        </div>
                                    ...
                                    <div class="simple__product__items">
                                        <div class="simple__product__thumb">
                                            <a href="#"><img src="{{asset('../asset/users')}}/images/slider_image/product1-1.jpg" alt=""></a>
                                        </div>
                                        <div class="simple__product__content">
                                            <div class="tag__cate">
                                                <a href="#">Women</a>
                                    ...
                                    <div class="product__navactive">
                                        <div class="product__sliders">
                                            <div class="box__sliders">
                                                <div class="slider__image"><a href="#"><img src="{{asset('../asset/users')}}/images/products/product1-1.jpg" alt=""></a></div>
                                                <div class="slider__image"><a href="#"><img src="{{asset('../asset/users')}}/images/products/product1.jpg" alt=""></a></div>
                                                <div class="slider__image"><a href="#"><img src="{{asset('../asset/users')}}/images/products/product1-1.jpg" alt=""></a></div>
                                                <div class="slider__image"><a href="#"><img src="{{asset('../asset/users')}}/images/products/product1.jpg" alt=""></a></div>
                                                <div class="slider__image"><a href="#"><img src="{{asset('../asset/users')}}/images/products/product1-1.jpg" alt=""></a></div>
                                                <div class="slider__image"><a href="#"><img src="{{asset('../asset/users')}}/images/products/product1.jpg" alt=""></a></div>
